...
Authors: Serenity Fan, Cristina Pirela, Santiago Rodriguez, Young-Ju Man
---
...
# Inspect the resulting geometry type
st_geometry_type(camp_centers)

# Using the conversion factor to create the buffer around the camp center point
camp_center_buffer <- st_buffer(
  camp_centers,
  dist = units::set_units (5, "m")
)
